<template>
  <div style="width: 100%;">
    <div class="alert alert-success alert-dismissible">
      ...
      <h4><i class="icon fa fa-check"></i>VM Chooser has become a part of VM Optimizer!</h4>
      The next generation of VM Chooser('s "Bulk Uploader") at <a href="https://www.vmoptimizer.com/#/getstarted-vmchooser" target="_blank">vmoptimizer.com</a> has reached feature parity with this version. 
      Be aware that from now on this version will NOT be updated anymore and that vmchooser.com will be sunset on the 1st of July 2021!
    </div>
